...
import { createInfoPost } from "@/lib/actions/info";
import { INFO_CATEGORY_SLUGS, INFO_CATEGORY_LABEL } from "@/lib/info-categories";
import { useRouter } from "next/navigation";
import { useState } from "react";

export function NewInfoPostForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await createInfoPost(formData);
    setLoading(false);
    if ("error" in result) {
